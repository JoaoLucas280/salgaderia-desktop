...
public class TelaPedido extends JPanel {
    ...
    private void salvarPedido() {
        ...
        pedido.setEndereco(endereco.isEmpty() ? null : endereco);
    ...
    private void gerarNotaPedido(Pedido pedido) {
        ...
        fileChooser.setSelectedFile(new java.io.File("nota_pedido_" + pedido.getId() + ".xlsx"));
        ...
        if (!arquivo.getName().toLowerCase().endsWith(".xlsx")) {
            arquivo = new java.io.File(arquivo.getParentFile(), arquivo.getName() + ".xlsx");
        }
